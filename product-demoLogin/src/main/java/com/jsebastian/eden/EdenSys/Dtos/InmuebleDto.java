...
public record InmuebleDto(
    ...
    @Valid @NotNull(message = "La ubicación es obligatoria") Ubicacion ubicacion,
    @NotNull(message = "El tipo de negocio es obligatorio") TipoNegocio tipoNegocio,
    @Valid @NotNull(message = "El agente asociado es obligatorio") AgenteInmobiliario agenteAsociado,
    @Valid @NotNull(message = "La lista de documentos importantes es obligatoria") List<DocumentoImportante> documentosImportantes,
    ...
    @NotNull(message = "El estado de la transacción es obligatorio") EstadoTransaccion estadoTransa,
    ...
    @Valid @NotNull(message = "El historial es obligatorio") List<HistorialInmueble> historial,
    @Valid @NotNull(message = "El asesor legal es obligatorio") AsesorLegal asesorLegal,
    ...
    @Valid @NotNull(message = "La lista de imágenes es obligatoria") List<Imagen> imagenes
) {}
